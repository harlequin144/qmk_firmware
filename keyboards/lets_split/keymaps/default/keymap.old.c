...
[_QWERTY] = LAYOUT_ortho_4x12(
   ...
   TT(_NUM),KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, RCTL_T(KC_UP), KC_RGHT \
),
...
[_RAISE] = LAYOUT_ortho_4x12( \
  KC_GRV , KC_F1   , KC_F2  , KC_F3  , KC_F4 , XXXXXXX, KC_MPRV, KC_MPLY        , KC_MNXT     , XXXXXXX  , XXXXXXX, KC_DELT, \
  _______, KC_F5   , KC_F6  , KC_F7  , KC_F8 , XXXXXXX, KC_BTN4, LCTL(S(KC_TAB)), LCTL(KC_TAB), KC_BTN5  , XXXXXXX, XXXXXXX, \
  _______, KC_F9   , KC_F10 , KC_F11 , KC_F12, XXXXXXX, XXXXXXX, KC_MUTE        , XXXXXXX     , XXXXXXX  , XXXXXXX, _______, \
  _______, _______, _______, _______, XXXXXXX, _______, _______, XXXXXXX        , KC_HOME     , KC_PGDOWN, KC_PGUP, KC_END \
),
...
[_NUM] =  LAYOUT_ortho_4x12( \
  ...
  _______, KC_F5   , KC_F6  , KC_F7  , KC_F8  , XXXXXXX, XXXXXXX, KC_4   , KC_5, KC_6   , XXXXXXX, XXXXXXX, \
  _______, KC_F9   , KC_F10 , KC_F11 , KC_F12 , XXXXXXX, XXXXXXX, KC_1   , KC_2, KC_3   , XXXXXXX, _______, \
  _______, _______ , _______, _______, XXXXXXX, _______, _______, XXXXXXX, KC_0, XXXXXXX, XXXXXXX, XXXXXXX \
)
};
